...
class Maxwell_Pro {
	...
	static function constants() {
		...
		define( 'MAXWELL_PRO_VERSION', '2.2.1' );
	...
	static function includes() {
		...
		require_once MAXWELL_PRO_PLUGIN_DIR . 'includes/modules/class-block-colors.php';
		...
		require_once MAXWELL_PRO_PLUGIN_DIR . '/includes/modules/class-header-search.php';
		require_once MAXWELL_PRO_PLUGIN_DIR . 'includes/modules/class-header-spacing.php';
		require_once MAXWELL_PRO_PLUGIN_DIR . '/includes/modules/class-scroll-to-top.php';
		require_once MAXWELL_PRO_PLUGIN_DIR . 'includes/modules/class-widget-areas.php';
