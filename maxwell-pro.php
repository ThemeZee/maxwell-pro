...
Description: Adds additional features like footer widgets, custom colors, custom fonts and Magazine widgets to the Maxwell theme.
Author: ThemeZee
...
class Maxwell_Pro {
	...
	static function constants() {
		...
		// Define Plugin Name
		define( 'MAXWELL_PRO_PRODUCT_ID', 53694 );
