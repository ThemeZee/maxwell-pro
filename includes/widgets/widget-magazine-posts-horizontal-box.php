...
class Maxwell_Pro_Magazine_Horizontal_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Horizontal Box)', 'maxwell' ), // Name.
			array(
				'classname' => 'maxwell-magazine-horizontal-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a horizontal box. Please use this widget ONLY in the Magazine Homepage widget area.', 'maxwell' ),
 ...
 * Register Widget
 */
function maxwell_register_magazine_posts_horizontal_box_widget() {

	register_widget( 'Maxwell_Pro_Magazine_Horizontal_Box_Widget' );

}
add_action( 'widgets_init', 'maxwell_register_magazine_posts_horizontal_box_widget' );
