...
if ( ! class_exists( 'Maxwell_Pro_Custom_Fonts' ) ) :
...
class Maxwell_Pro_Custom_Fonts {
	...
	*/
	static function setup() {
		...
		require_once MAXWELL_PRO_PLUGIN_DIR . 'includes/customizer/class-font-list.php';
		require_once MAXWELL_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-control.php';
		require_once MAXWELL_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-list-control.php';
		
		// Add Custom Color CSS code to custom stylesheet output
		add_filter( 'maxwell_pro_custom_css_stylesheet', array( __CLASS__, 'custom_fonts_css' ) ); 
		
		// Load custom fonts from Google web font API
		add_filter( 'maxwell_google_fonts_url', array( __CLASS__, 'google_fonts_url' ) );
	...
	static function google_fonts_url( $google_fonts_url ) { 
		...
		$default_fonts = Maxwell_Pro_Custom_Font_Lists::default_browser_fonts();
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'maxwell_pro_section_fonts', array(
			'title'    => __( 'Theme Fonts', 'maxwell-pro' ),
			'priority' => 70,
		...
		$wp_customize->add_control( new Maxwell_Pro_Customize_Font_Control( 
			$wp_customize, 'text_font', array(
				'label'      => __( 'Base Font', 'maxwell-pro' ),
				'section'    => 'maxwell_pro_section_fonts',
		...
		$wp_customize->add_control( new Maxwell_Pro_Customize_Font_Control( 
			$wp_customize, 'title_font', array(
				'label'      => _x( 'Headings', 'font setting', 'maxwell-pro' ),
				'section'    => 'maxwell_pro_section_fonts',
		...
		$wp_customize->add_control( new Maxwell_Pro_Customize_Font_Control( 
			$wp_customize, 'navi_font', array(
				'label'      => _x( 'Navigation', 'font setting', 'maxwell-pro' ),
				'section'    => 'maxwell_pro_section_fonts',
		...
		$wp_customize->add_control( new Maxwell_Pro_Customize_Font_Control( 
			$wp_customize, 'widget_title_font', array(
				'label'      => _x( 'Widget Titles', 'font setting', 'maxwell-pro' ),
				'section'    => 'maxwell_pro_section_fonts',
		...
		$wp_customize->add_setting( 'maxwell_theme_options[available_fonts]', array(
			'default'           => 'favorites',
			'type'           	=> 'option',
			'transport'         => 'postMessage',
		...
		$wp_customize->add_control( new Maxwell_Pro_Customize_Font_List_Control( 
			$wp_customize, 'maxwell_control_available_fonts', array(
				'label'      => __( 'Choose available Fonts', 'maxwell-pro' ),
				'section'    => 'maxwell_pro_section_fonts',
				'settings'   => 'maxwell_theme_options[available_fonts]',
				'choices' => array(
					'default' => __( 'Default Browser Fonts (12)', 'maxwell-pro' ),
					'favorites' => __( 'ThemeZee Favorite Fonts (35)', 'maxwell-pro' ),
					'popular' => __( 'Most Popular Google Fonts (100)', 'maxwell-pro' ),
					'all' => __( 'All Google Fonts (650)', 'maxwell-pro' )
					),
				'priority' => 5
			) ) 
		);
