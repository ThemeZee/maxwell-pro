...
class Maxwell_Pro_Header_Search {
	...
	static function enqueue_script() {
		...
		if ( ( true === $theme_options['header_search'] || is_customize_preview() ) && ! self::is_amp() ) :
			...
			wp_enqueue_script( 'maxwell-pro-header-search', MAXWELL_PRO_PLUGIN_URL . 'assets/js/header-search.min.js', array(), '20220121', true );
	...
	static function add_header_search() {
		...
		if ( true === $theme_options['header_search'] || is_customize_preview() ) : ?>
			...
			<div class="header-search">
				...
				<button class="header-search-icon" aria-label="<?php esc_attr_e( 'Open search form', 'maxwell-pro' ); ?>" aria-expanded="false" aria-controls="header-search-dropdown" <?php self::amp_search_toggle(); ?>>
